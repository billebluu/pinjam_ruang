    ...
    if(isset($_POST["submit"])){
        ...
        if(inputRuang($_POST) > 0){
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                }, 2000); // Mengarahkan ke halaman admin-data-ruang.php setelah 3 detik (3000 ms)
            });
            </script>";
        }else{
            echo "<script>
            ...
            <div class="modal-dialog" data-bs-dismiss="modal">
                <div class="modal-content p-4 d-flex flex-row" style="background-color:#c9efff; border-radius:30px; align-items: center; justify-items: center;">
                    ...
                    <div class="flex-column">
                        <div>
                            <h1 class="mx-4 fs-5 text-center" style="font-weight: bolder;" id="staticBackdropLabel">Data Ruangan Baru Berhasil Ditambahkan!</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="modalFailAddData" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog" data-bs-dismiss="modal">
                <div class="modal-content p-4 d-flex flex-row" style="background-color:#c9efff; border-radius:30px; align-items: center; justify-items: center;">
                    ...
                    <div class="flex-column">
                        <div>
                            <h1 class="mx-4 fs-5 text-center" style="font-weight: bolder;" id="staticBackdropLabel">Data Ruangan Baru Gagal Ditambahkan!</h1>
                        </div>
                    </div>
                </div>
            </div>
