                                                ...
                                                <tbody class="table table-hover" style="text-align: center;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="button-action" style="background-color: rgb(201,239,255);" data-bs-toggle="modal" data-bs-target="#modalConfirmation<?= $row["id_ajuan"]; ?>">
                                                                <a class="nav-link">Validasi</a>
                                                            </button>
                                                            <?php endif ?>
                                                        </td>

                                                        <div class="modal fade" id="modalConfirmation<?= $row["id_ajuan"]; ?>" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
