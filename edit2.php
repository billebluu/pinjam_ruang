...
<html>
    ...
    <body>
                                ...
                                <div class="col-auto min-vh-100 d-flex flex-column justify-content-between">
                                    <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="statusUser"  name="statusUser" value="<?= $user["statusUser"]; ?>" required>
                                        </div>
                                        <div class="col-md-5">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="nim_nip"  name="nim_nip" value="<?= $user["nim_nip"]; ?>" required>
                                        </div>
                                        <div class="col-12">
                                            <br><br>
        ...
        <!-- Modal Berhasil Edit User -->
        <div class="modal fade" id="modalEditData" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content p-4 d-flex flex-row" style="background-color:#c9efff; border-radius:30px; align-items: center; justify-items: center;">
                    ...
                    <div class="flex-column">
                        <div>
                            <h1 class="mx-4 fs-5 text-center" style="font-weight: bolder;" id="staticBackdropLabel">Data User Baru Berhasil Diperbarui!</h1>
                        </div>
                    </div>
                </div>
            </div>
