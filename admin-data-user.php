                            ...
                            <h5 class="admin-text"><strong>Admin</strong></h5>
                                <div class="data-text">
                                    ...
                                    <form action="" method="post" class="d-flex" role="search">
                                        <div class="col-sm-4">
                                            <input type="text" name="keyword" class="form-control" placeholder="Search Bar">
                                        </div>
                                        <button class="button-search" type="submit" name="search">Cari</button>
                                        <button class="button-input"><a class="nav-link" href="admin-input-data-user.php?id=<?= $id; ?>" style="color: rgb(0, 0, 0);">Input</a></button>
                                    </form>
