                                        ...
                                        <section>
                                            <div class="container-profile" align="left">
                                                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <input type="hidden" name="berkasLama" value="<?= $data_pengajuan["berkas"]; ?>">
                                                    <div class="col-md-5">
                                                        <label for="nama_pengaju" class="form-label">Nama Pengaju</label>
                                                        <input type="text" class="form-control" name="nama_pengaju"  id="nama_pengaju" value="<?= $data_pengajuan["nama_pengaju"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="nama_ruang" class="form-label">Ruang</label>
                                                        <input type="text" class="form-control" id="nama_ruang"  name="nama_ruang" value="<?= $data_pengajuan["nama_ruang"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="email" class="form-label">Email</label>
                                                        <input type="text" class="form-control" id="email"  name="email" value="<?= $data_pengajuan["email"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="kegiatan" class="form-label">Kegiatan</label>
                                                        <input type="text" class="form-control" id="kegiatan"  name="kegiatan" value="<?= $data_pengajuan["kegiatan"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="phone" class="form-label">No. Telephone</label>
                                                        <input type="text" class="form-control" id="phone"  name="phone" value="<?= $data_pengajuan["phone"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="waktu" class="form-label">Waktu</label>
                                                        <input type="time" class="form-control" id="waktu"  name="waktu" value="<?= $data_pengajuan["waktu"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="nim_nip" class="form-label">NIM/NIP</label>
                                                        <input type="text" class="form-control" id="nim_nip"  name="nim_nip" value="<?= $data_pengajuan["nim_nip"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="tgl_awal" class="form-label">Tanggal Awal Peminjaman</label>
                                                        <input type="date" class="form-control" id="tgl_awal"  name="tgl_awal" value="<?= $data_pengajuan["tgl_awal"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="tgl_akhir" class="form-label">Tanggal Akhir Peminjaman</label>
                                                        <input type="date" class="form-control" id="tgl_akhir"  name="tgl_akhir" value="<?= $data_pengajuan["tgl_akhir"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="sik">Berkas</label><br>
                                                        <file src="file/<?= $data_pengajuan["sik"]; ?>" alt="none" width="80px" height="60px"><br>
                                                        <input type="file" name="sik" id="sik" value="<?= $data_pengajuan["sik"]; ?>" required>
                                                    </div>
                                                    <div class="col-12">
                                                        <br><br>
            ...
            <div class="modal-dialog" data-bs-dismiss="modal">
                <div class="modal-content p-4 d-flex flex-row" style="background-color:#c9efff; border-radius:30px; align-items: center; justify-items: center;">
                    ...
                    <div class="flex-column">
                        <div>
                            <h1 class="mx-4 fs-5 text-center" style="font-weight: bolder;" id="staticBackdropLabel">Data Pengajuan Berhasil Diperbarui!</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="modalFailEditData" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog" data-bs-dismiss="modal">
                <div class="modal-content p-4 d-flex flex-row" style="background-color:#c9efff; border-radius:30px; align-items: center; justify-items: center;">
                    ...
                    <div class="flex-column">
                        <div>
                            <h1 class="mx-4 fs-5 text-center" style="font-weight: bolder;" id="staticBackdropLabel">Data Pengajuan Gagal Diperbarui!</h1>
                        </div>
                    </div>
                </div>
            </div>
