<?php
    ...
    if(isset($_POST["search"])){
        $data_laporan = searchLaporan($_POST["keyword"]);
    }
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-auto col-sm-9 p-5 min-vh-100 d-flex flex-column justify-content-between" style="margin-left:320px; border-radius: 0 50px 50px 0;">
                        <div>
                            <h5 class="admin-text"><strong>Admin</strong></h5>
                                <div class="data-text">
                                    <h1><strong>Laporan Peminjaman Ruangan</strong></h1>
                                    <br>
                                    <form action="" method="post" class="d-flex" role="search">
                                        ...
                                        <!-- <button class="button-input"><a class="nav-link" href="admin-input-data-laporan-pinjam.php" style="color: rgb(0, 0, 0);">Input</a></button> -->
                                    </form>
