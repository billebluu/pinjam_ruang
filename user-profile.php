      ...
      <div class="container-profile" align="left">
                ...
                <input type="hidden" name="id" value="<?= $user["id"]; ?>">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="nama"  name="nama" value="<?php echo $user['nama'] ?>" disabled>
                    </div>
                    <div class="col-md-5">
                        <label for="statusUser" class="form-label">Status</label>
                        <input type="text" class="form-control" id="statusUser"  name="statusUser" value="<?php echo $user['statusUser'] ?>" disabled>
                    </div>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="nim_nip"  name="nim_nip" value="<?php echo $user['nim_nip'] ?>" disabled>
                    </div>
                </form>
                <div class="col-12">
                    <br><br>
                    <!-- type="submit" name="submit" -->
                    <button type="submit" name="submit" class="user-profile"><a class="nav-link" href="edit-profile.php?id=<?= $id; ?>" style="color: #ffffff; background-color: black;">Edit</a></button>
                </div>
            </div>
      </section>
