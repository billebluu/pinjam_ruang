<?php
   ...
   $user = query($data);
   $data_ruangan = query("SELECT * FROM data_ruangan WHERE id=$id")[0];
                                            ...
                                            <div class="container-profile" align="left">
                                                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_ruang"  id="nama_ruang"  value="<?= $data_ruangan["nama_ruang"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="fasilitas" class="form-label">Fasilitas*</label>
                                                        <input type="text" class="form-control" id="fasilitas"  name="fasilitas"  value="<?= $data_ruangan["fasilitas"]; ?>" required>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="kapasitas" class="form-label">Kapasitas Orang*</label>
                                                        <input type="text" class="form-control" id="kapasitas"  name="kapasitas"  value="<?= $data_ruangan["kapasitas"]; ?>" required>
                                                    </div>
                                                    <div class="col-12">
                                                        <br><br>
            ...
            <div class="modal-dialog" data-bs-dismiss="modal">
                <div class="modal-content p-4 d-flex flex-row" style="background-color:#c9efff; border-radius:30px; align-items: center; justify-items: center;">
                    ...
                    <div class="flex-column">
                        <div>
                            <h1 class="mx-4 fs-5 text-center" style="font-weight: bolder;" id="staticBackdropLabel">Data Ruangan Berhasil Diperbarui!</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="modalFailEditData" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog" data-bs-dismiss="modal">
                <div class="modal-content p-4 d-flex flex-row" style="background-color:#c9efff; border-radius:30px; align-items: center; justify-items: center;">
                    ...
                    <div class="flex-column">
                        <div>
                            <h1 class="mx-4 fs-5 text-center" style="font-weight: bolder;" id="staticBackdropLabel">Data Ruangan Gagal Diperbarui!</h1>
                        </div>
                    </div>
                </div>
            </div>
