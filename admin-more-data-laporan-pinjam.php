                                            ...
                                            <div class="container-profile" align="left">
                                                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input type="time" class="form-control" id="waktu"  name="waktu" value="<?= date("H:i", strtotime($data_laporan["waktu"])); ?>" disabled>
                                                    </div>
                                                    <div class="col-md-5">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input type="date" class="form-control" id="tgl_awal"  name="tgl_awal" value="<?= $data_laporan["tgl_awal"]; ?>" disabled>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label for="tgl_akhir" class="form-label">Tanggal Akhir Peminjaman</label>
                                                        <input type="date" class="form-control" id="tgl_akhir"  name="tgl_akhir" value="<?= $data_laporan["tgl_akhir"]; ?>" disabled>
                                                    </div><br><br><br><br><br>
